<x-app-layout>
    ...
    <div class="py-10"><div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="grid gap-6 lg:grid-cols-[1fr_2fr]">
            <form method="POST" action="{{ route('management.users.store') }}" class="space-y-4 bg-white p-6 shadow-sm sm:rounded-lg" enctype="multipart/form-data">
                @csrf

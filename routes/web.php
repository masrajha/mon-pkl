...
use App\Http\Controllers\Management\WfaRequestController as ManagementWfaRequestController;
...
use App\Http\Controllers\Student\WfaRequestController as StudentWfaRequestController;
...
use App\Http\Controllers\WfaRequestApprovalController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:mahasiswa')->group(function () {
        ...
        Route::get('/student/wfa-requests', [StudentWfaRequestController::class, 'index'])->name('student.wfa-requests.index');
        Route::get('/student/wfa-requests/create', [StudentWfaRequestController::class, 'create'])->name('student.wfa-requests.create');
        Route::post('/student/wfa-requests', [StudentWfaRequestController::class, 'store'])->name('student.wfa-requests.store');
        Route::patch('/student/wfa-requests/{wfaRequest}/cancel', [StudentWfaRequestController::class, 'cancel'])->name('student.wfa-requests.cancel');
    ...
    Route::middleware('role:admin,koordinator')->group(function () {
        ...
        Route::get('/management/wfa-requests', [ManagementWfaRequestController::class, 'index'])->name('management.wfa-requests.index');
        Route::post('/management/wfa-requests/{wfaRequest}/approve', [WfaRequestApprovalController::class, 'approveAsManagement'])->name('wfa-requests.management.approve');
        Route::post('/management/wfa-requests/{wfaRequest}/reject', [WfaRequestApprovalController::class, 'rejectAsManagement'])->name('wfa-requests.management.reject');
    ...
    Route::middleware('role:admin,dosen,koordinator')->group(function () {
        ...
        Route::get('/management/submission-progress/{progress}', [ManagementSubmissionProgressController::class, 'redirectToIndex'])->name('management.submission-progress.show');
        Route::match(['post', 'patch'], '/management/submission-progress/{progress}', [ManagementSubmissionProgressController::class, 'update'])->name('management.submission-progress.update');

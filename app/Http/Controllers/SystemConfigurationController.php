...
class SystemConfigurationController extends Controller
{
    ...
    public function update(Request $request, InternshipPeriod $period): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'check_in.max_location_accuracy_meters' => ['required', 'integer', 'min:0', 'max:100000'],
            'check_in.location_sample_max_age_minutes' => ['required', 'integer', 'min:1', 'max:60'],
            'check_in.location_sample_mismatch_tolerance_meters' => ['required', 'integer', 'min:0', 'max:100000'],
            ...
            'final_assessment_document.faculty' => ['required', 'string', 'max:255'],
            'final_assessment_document.department' => ['required', 'string', 'max:255'],
            'final_assessment_document.address' => ['nullable', 'string', 'max:500'],
            'final_assessment_document.phone' => ['nullable', 'string', 'max:255'],
            'final_assessment_document.fax' => ['nullable', 'string', 'max:255'],
            'final_assessment_document.website' => ['nullable', 'string', 'max:255'],
            'final_assessment_document.email' => ['nullable', 'string', 'max:255'],
            'final_assessment_document.document_number_format' => ['required', 'string', 'max:255'],
            'final_assessment_document.city' => ['required', 'string', 'max:255'],
            'final_assessment_document.chair_name' => ['nullable', 'string', 'max:255'],
            'final_assessment_document.chair_identifier' => ['nullable', 'string', 'max:255'],

...
return [
    ...
    'check_in' => [
        ...
        'max_location_accuracy_meters' => (int) env('MONPKL_CHECKIN_MAX_LOCATION_ACCURACY_METERS', 100),
        'location_sample_max_age_minutes' => (int) env('MONPKL_CHECKIN_LOCATION_SAMPLE_MAX_AGE_MINUTES', 5),
        'location_sample_mismatch_tolerance_meters' => (int) env('MONPKL_CHECKIN_LOCATION_SAMPLE_MISMATCH_TOLERANCE_METERS', 100),
